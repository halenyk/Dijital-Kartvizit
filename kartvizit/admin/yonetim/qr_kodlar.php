...
$stmt = $db->prepare("SELECT qr_resim, url, olusturulma_tarihi FROM qr_kodlar ORDER BY olusturulma_tarihi DESC");
$stmt->execute();
$qr_kodlar = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<style>
        .truncate {
           ...
           <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">QR Kodlar /</span> Tüm QR Kodlar</h4>
                        <div class="d-flex justify-content-start mb-3">
                            <a href="qr_olustur.php" class="btn btn-primary">
                                <i class="bx bx-plus me-1"></i> QR Kodu Oluştur
                            </a>
                        </div>
                        <div class="card">
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0" id="qrTableBody">
                                        <?php if (count($qr_kodlar) > 0): ?>
                                            <?php foreach ($qr_kodlar as $qr): ?>
                                                <tr>
                                                    <td><img src="<?php echo htmlspecialchars($qr['qr_resim']); ?>" alt="QR Kodu" width="100"></td>
                                                    <td>
                                                        <a href="<?php echo htmlspecialchars($qr['url']); ?>" target="_blank" class="truncate" title="<?php echo htmlspecialchars($qr['url']); ?>">
                                                            <?php echo htmlspecialchars($qr['url']); ?>
                                                        </a>
                                                    </td>
                                                    
                                                    <td><?php echo htmlspecialchars(formatDate($qr['olusturulma_tarihi'])); ?></td>
                                                    <td>
                                                        <a href="<?php echo htmlspecialchars($qr['qr_resim']); ?>" download class="btn btn-secondary btn-sm">
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="4" class="text-center">Hiç QR kod bulunamadı.</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
