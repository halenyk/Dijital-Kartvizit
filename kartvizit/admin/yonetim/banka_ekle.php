...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        try {
            $stmt = $db->prepare("INSERT INTO banka_hesaplari (banka_ad, banka_logo, iban, iban_kisi) VALUES (?, ?, ?, ?)");
            $stmt->execute([$banka_ad, $banka_logo, $iban, $iban_kisi]);
            $success = true;
...
<li class="menu-item">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Banka Hesapları /</span> Banka Hesabı Ekle</h4>
        <div class="row">
            <div class="col-md">
                <div class="card mb-4">
                    <h5 class="card-header">Banka Hesabı Ekle</h5>
                    <?php if ($success): ?>
                    ...
                    <div class="card-body pt-4">
                        <form action="banka_ekle.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="banka_ad">Banka Adı</label>
                                <input type="text" class="form-control" id="banka_ad" name="banka_ad" required>
                                <div id="bankaAdHelp" class="form-text">Lütfen banka adını giriniz.</div>
                            </div>
                            <div class="form-group">
                                <label for="iban">IBAN</label>
                                <input type="text" class="form-control" id="iban" name="iban" required>
                                <div id="ibanHelp" class="form-text">Lütfen IBAN numarasını giriniz.</div>
                            </div>
                            <div class="form-group">
                                <label for="iban_kisi">IBAN Sahibi</label>
                                <input type="text" class="form-control" id="iban_kisi" name="iban_kisi" required>
                                <div id="ibanKisiHelp" class="form-text">Lütfen IBAN sahibini giriniz.</div>
                            </div>
                            <div class="form-group">
                                <label for="banka_logo">Banka Logosu</label>
                                <input type="file" class="form-control" id="banka_logo" name="banka_logo" accept="image/*" required>
                                <div id="bankaLogoHelp" class="form-text">Lütfen banka logosunu seçiniz.</div>
                            </div>
